      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-6 text-cream/80 text-lg">
            From our infinity pool overlooking Lake Tanganyika to the spa and
            private beach—every detail is designed for your comfort.
          </p>
        </motion.div>
          ...
          {amenities.map((amenity, index) => {
            ...
            return (
              <motion.div
                ...
                className={cn(
                  "glass-dark rounded-lg p-8 border border-white/10",
